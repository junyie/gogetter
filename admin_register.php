...
<?php
       if(isset($_SESSION["admin_username"]) && isset($_SESSION["identity"]))  
	   {
		 ...
		 echo "<a href='admin_dashboard.php' class='w3-bar-item w3-button w3-padding-large'>Login</a>";
	   }else{
		 echo "<a href='admin_register.php' class='w3-bar-item w3-button w3-padding-large'>Register</a>";
		 echo "<a href='admin_logging.php' class='w3-bar-item w3-button w3-padding-large'>Admin Login</a>";
...
<h3 class="panel-title register-title">Registering Admin Accounts</h3>
</div>
<div class="panel-body">
<form id="signupForm1" method="post" class="form-horizontal" action="admin_register_controller.php">

<div class="form-group">
<label class="col-sm-4 control-label" for="admin_username">Username: </label>
<div class="col-sm-5">
...
<div class="form-group">
<label class="col-sm-4 control-label" for="admin_password">Password: </label>
<div class="col-sm-5">
<input type="password" class="form-control" id="admin_password" name="admin_password" placeholder="Password" />
</div>
</div>
<div class="form-group">
<label class="col-sm-4 control-label" for="confirm_admin_password">Confirm password: </label>
<div class="col-sm-5">
<input type="password" class="form-control" id="confirm_admin_password" name="confirm_admin_password" placeholder="Confirm password" />
</div>
</div>
